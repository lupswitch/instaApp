...
$config['instagram_client_id']		= 'myclientid';
$config['instagram_client_secret']	= 'myclientsecretkey';
$config['instagram_callback_url']	= 'mypath/index.php/authorize/get_code';
$config['instagram_website']		= 'mypath';
